namespace :card_sources do
  ...
  task set: :environment do
    ...
    Card.find_by(name: 'Morbol').sources.find_or_create_by(origin: 'Dungeon', name: 'The Aurum Vale')
    Card.find_by(name: 'The Griffin').sources.find_or_create_by(origin: 'Dungeon', name: "Baelsar's Wall")
    Card.find_by(name: 'Livia sas Junius').sources.find_or_create_by(origin: 'Dungeon', name: 'Castrum Meridianum')
    ...
    Card.find_by(name: 'Griffin').sources.find_or_create_by(origin: 'Dungeon', name: 'The Dusk Vigil')
    ...
    Card.find_by(name: 'Blue Dragon').sources.find_or_create_by(origin: 'Dungeon', name: 'The Stone Vigil')
    Card.find_by(name: 'Blue Dragon').sources.find_or_create_by(origin: 'Dungeon', name: 'The Stone Vigil (Hard)')
    ...
    Card.find_by(name: 'Genbu').sources.find_or_create_by(origin: 'Dungeon', name: "Hells' Lid")
    ...
    # Raids
    Card.find_by(name: 'Phlegethon').sources.find_or_create_by(origin: 'Raid', name: 'The Labyrinth of the Ancients')
    ...
    Card.find_by(name: 'Cloud of Darkness').sources.find_or_create_by(origin: 'Raid', name: 'The World of Darkness')
    Card.find_by(name: 'Onion Knight').sources.find_or_create_by(origin: 'Raid', name: 'The World of Darkness')
    ...
    # Achievements
    Card.find_by(name: 'Heavensward Thancred').sources.find_or_create_by(origin: 'Achievement', name: 'Triple Team V')
    Card.find_by(name: 'Midgardsormr').sources.find_or_create_by(origin: 'Achievement', name: 'Triple-Decker IV')
    Card.find_by(name: 'Vidofnir').sources.find_or_create_by(origin: 'Achievement', name: 'Triple-Decker V')
    Card.find_by(name: "Heavensward Y'shtola").sources.find_or_create_by(origin: 'Achievement', name: 'Triple-Decker VI')
    Card.find_by(name: 'Lyse').sources.find_or_create_by(origin: 'Achievement', name: 'Triple-Decker VII')
    Card.find_by(name: 'Gosetsu').sources.find_or_create_by(origin: 'Achievement', name: 'Triple-Decker VIII')
    Card.find_by(name: 'Shantotto').sources.find_or_create_by(origin: 'Achievement', name: 'Kumite Kumite Kumite')
    Card.find_by(name: 'Squall Leonhart').sources.find_or_create_by(origin: 'Achievement', name: 'Triple Team II')
    Card.find_by(name: 'Haurchefant').sources.find_or_create_by(origin: 'Achievement', name: 'Triple Team III')
    Card.find_by(name: 'Krile').sources.find_or_create_by(origin: 'Achievement', name: 'Triple Team VII')
    Card.find_by(name: 'Vaan').sources.find_or_create_by(origin: 'Achievement', name: 'Wheel of Fortune V')
